    ...
    <Stack gap={20}>
      ...
      <Container>
        ...
        >
          ...
          >
            <Reveal>Discover our Indian food that makes you drool</Reveal>
          </Typography>
          <Typography variant="body1" textAlign={'justify'}>
            <Reveal>
              Our Punjabi Touched Indian Restaurant is known for its delectable
              Frontier, Punjabi & Lucknawi food. With over 2 decades of journey
              in the hospitality Industry, our brand has made a mark for itself!
              We own multiple awards in this industry, which leaves an
              everlasting impression on one’s mind and heart. With us, you can
              get the holistic experience of Punjabi’s soulful cuisines to the
              village-themed Ambience. This is the perfect place to dine with
              your family and friends. Our dishes are curated with the finest
              level of ingredients, including spices and fresh herbs, with great
              attention. So come to enjoy our Culinary experience that you will
              treasure for life!
            </Reveal>
          </Typography>
        </Stack>
        ...
        <Grid container spacing={4} mt={2}>
          ...
          >
            <Stack gap={3} color="text.primary">
              ...
              >
                <Reveal>Experience the richness of flavours with us!</Reveal>
              </Typography>
              <Typography variant="body1">
                <Reveal>
              ...
              <Typography variant="body1">
                <Reveal>
                  Our foods are crafted with the utmost care and detailing so
                  that every bite can deliver an explosion of flavour that will
